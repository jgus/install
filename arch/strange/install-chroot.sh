...
sed -i 's/GRUB_CMDLINE_LINUX_DEFAULT="\(.*\)"/GRUB_CMDLINE_LINUX_DEFAULT="\1 nvidia-drm.modeset=1 cryptdevice=/dev/disk/by-label/lockedz0:lockedz0 cryptdevice=/dev/disk/by-label/lockedz1:lockedz1 cryptdevice=/dev/disk/by-label/lockedz2:lockedz2 cryptdevice=/dev/disk/by-label/lockedz3:lockedz3 cryptdevice=/dev/disk/by-label/lockedswap0:lockedswap0 cryptdevice=/dev/disk/by-label/lockedswap1:lockedswap1 cryptdevice=/dev/disk/by-label/lockedswap2:lockedswap2 cryptdevice=/dev/disk/by-label/lockedswap3:lockedswap3 cryptkey=/dev/disk/by-label/KEYFILE:ext2:/system"/g' /etc/default/grub
