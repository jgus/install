...
SYSTEM_DEVICES=(
    ata-SanDisk_SDSSDHII240G_143442404436
    )
SYSTEM_Z_TYPE=
Z_PART_END="176GiB"
BULK_DEVICE=
...
do
    ...
    parted -s "${DEVICE}" -- mkpart primary 512MiB 2048MiB
    parted -s "${DEVICE}" -- mkpart primary 2048MiB "${Z_PART_END}"
